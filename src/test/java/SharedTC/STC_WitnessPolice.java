...
public class STC_WitnessPolice {
	...
	public void witnessPolice(Testing test) {
		...
		test.webFunctions().type(test,witnessPolice.textbox_OfficerName,test.getTestData("WitnessPolice.OfficerName"));
		test.webFunctions().type(test,witnessPolice.textbox_ReportNumber,test.getTestData("WitnessPolice.ReportNumber"));
