...
public class WitnessesAndPolice {
	...
	@FindBy(xpath = "//mat-radio-group[@formcontrolname='policeContactRadio']/mat-radio-button[1]")
	public WebElement btn_PoliceContactedYes;

	// @FindBy(xpath = "//mat-radio-button[contains(@id,'mat-radio-12')]")
	@FindBy(xpath = "//mat-radio-group[@formcontrolname='policeContactRadio']/mat-radio-button[2]")
